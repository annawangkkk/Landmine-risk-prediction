...
if __name__ == '__main__':
    ...
    if args.mode in ('both', 'div'):
        ...
        div = np.clip(compute_div(p, q, probs, args.eps_div), 0, 1)
    ...
    if args.mode in ('both', 'cor'):
        ...
        cor = np.clip(compute_cor(y_p, z_p, y_q, z_q, p, q, probs, points, args.eps_cor,
                          strict=args.strict),0,1) # code is buggy?
